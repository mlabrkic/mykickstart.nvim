...
vim.g.have_nerd_font = true -- mlabrkic
...
vim.opt.relativenumber = true -- mlabrkic
...
require('lazy').setup({
        ...
        callback = function(event)
          ...
          if client and client.server_capabilities.inlayHintProvider and vim.lsp.inlay_hint then
            map('<leader>th', function()
              vim.lsp.inlay_hint.enable(not vim.lsp.inlay_hint.is_enabled {}) -- mlabrkic: is_enabled {}
    ...
    config = function()
      ...
      cmp.setup {
        ...
        mapping = cmp.mapping.preset.insert {
          ...
          -- ['<C-n>'] = cmp.mapping.select_next_item(),  -- mlabrkic
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      -- ---@diagnostic disable-next-line: duplicate-set-field -- mlabrkic
...
require 'custom.gui' -- mlabrkic
require 'custom.utils' -- mlabrkic
